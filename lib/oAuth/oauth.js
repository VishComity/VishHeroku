...
oauth.retrieveAccessForRefreshToken = function(app, res, refreshToken) {
	var opts = connection.getOrg()._getOpts();
	console.log('Before calling refreshToken - '+JSON.stringify(opts));
	opts.oauth.refresh_token = refreshToken;
...
oauth.retrieveAuthDisplayInfo = function(req, res, app) {
	...
	oauth.retrieveRefreshToken('00Do0000000KC49EAG', app, res, oauth.retrieveAccessForRefreshToken);
